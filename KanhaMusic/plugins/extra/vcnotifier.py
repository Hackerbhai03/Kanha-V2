...
async def start_group_call(c: Client, m: Message):
    ...
    if not assistant:
        return await app.send_message(chat_id, "❌ Assistant Not Found")
    ...
    try:
        ...
        await msg.edit_text(
            "✅ 𝐕𝐎𝐈𝐂𝐄 𝐂𝐇𝐀𝐓 𝐒𝐓𝐀𝐑𝐓𝐄𝐃 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘 👑"
        )
        ...
        try:
            ...
            await msg.edit_text(
                "❌ Give Video Chat Permission To Bot"
            )
...
async def stop_group_call(c: Client, m: Message):
    ...
    try:
        group_call = await get_group_call(
            assistant, m, err_msg="• Already Ended"
        )
