...
from KanhaMusic.utils.inline.help import help_back_markup, private_help_panel, oyekanha_markup
...
@app.on_callback_query(filters.regex("oyekanha") & ~BANNED_USERS)
@languageCB
async def oyekanha_helper(client, CallbackQuery, _):
    await CallbackQuery.answer()
    await CallbackQuery.edit_message_reply_markup(
        reply_markup=oyekanha_markup(_)
    )
